...
2. Демонстрационные / учебные ТАБЛИЦЫ по ЛЮБОМУ предмету (русский, литература,
   математика, история, обществознание, география, химия, биология, физика,
   ОБЖ и т.д.) сопоставляй с ОБЩЕЙ позицией
   "[По предметной области] Комплект демонстрационных учебных таблиц".
   Выбирай именно её, а НЕ кабинетные одноимённые двойники (например
   "[Кабинет физики] Комплект демонстрационных учебных таблиц") и не предметные
   пособия/карты/модели. Кабинетный двойник бери только если товар — явно
   оборудование именно того кабинета.
